...
<div id="footer-wrapper">
    	...
    	<div class="container footer">
         ...
         <div class="copyright-wrapper">
        	<div class="container">
           		 <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','event-planners');?> <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/wedding/');?>" target="_blank">
        <?php esc_html_e('SKT Wedding Themes','event-planners'); ?>
        </a></div>
                 <div class="clear"></div>
            </div>           
        </div>
