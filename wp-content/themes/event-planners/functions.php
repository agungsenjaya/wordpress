...
define('EVENT_PLANNERS_SKTTHEMES_URL','https://www.sktthemes.org/');
define('EVENT_PLANNERS_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/event-agency-wordpress-theme/');
define('EVENT_PLANNERS_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-conference-wordpress-theme');
define('EVENT_PLANNERS_SKTTHEMES_THEME_DOC','https://sktthemesdemo.net/documentation/event-planner-documentation/');
define('EVENT_PLANNERS_SKTTHEMES_LIVE_DEMO','https://sktperfectdemo.com/demos/event-planners/');
define('EVENT_PLANNERS_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/');
/**
...
add_action( 'tgmpa_register', 'event_planners_register_required_plugins' );
 
function event_planners_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',
