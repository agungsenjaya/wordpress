...
<div class="left">
        ...
        <?php } 
		if (!empty($insta_link)) { ?>
        <a title="<?php echo esc_attr__('instagram','event-planners'); ?>" class="gp" target="_blank" href="<?php echo esc_url($insta_link); ?>"></a>
        <?php } 
  ...
  <div class="container">
    <div class="logo">
        ...
        <?php endif; ?>
         ...
         <div class="toggle"><a class="toggleMenu" href="#" style="display:none;"><?php esc_html_e('Menu','event-planners'); ?></a></div> 
        <div class="sitenav">
